...
namespace Zxxk.Gkbb.Common
{
    ...
    public class WebHelper
    {
        ...
        /// <returns></returns>
        public static string GetPostRequestData(string url, string postData, string contentType = "application/x-www-form-urlencoded")
        {
            if (!(url.Contains("http://") || url.Contains("https://")))
                url = "http://" + url;
            try
        ...
        public static string GetRequest(string url, string contentType = "application/x-www-form-urlencoded")
        {
            if (!(url.Contains("http://") || url.Contains("https://")))
                url = "http://" + url;
            try
